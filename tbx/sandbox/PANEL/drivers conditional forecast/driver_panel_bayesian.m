  ...
  if window_size>0
    ...
    if CF==1
      ...
      [nconds, cforecast_record, cforecast_estimates]=...
        cf_driver_NormalWishartPanel(N,n,m,p,k,q,cfconds,cfshocks,cfblocks,data_endo_a,data_exo_a,data_exo_p,It,Bu,Fperiods,const,beta_gibbs,D_record,gamma_record,CFt,Fband);
