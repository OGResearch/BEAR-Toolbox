function outSampler = lj_panel_rand_eff_hier_smpl(data_endo,data_exo,const,lags,lambda2,lambda3,lambda4,s0,v0, Bu)

    % compute preliminary elements
    [Xi, ~, ~, Yi, ~, y, numCountries, numEndog, numExog, numLags, T, ~, ~, ~]=bear.panel4prelim(data_endo,data_exo,const,lags);
