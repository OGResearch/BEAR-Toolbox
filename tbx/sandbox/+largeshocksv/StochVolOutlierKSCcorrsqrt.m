...
[h, hshock, h0]   = largeshocksv.rwnoisePrecisionBasedSampler(vecobs, Nsv, T, hVCVsqrt, noisevol, Eh0, sqrtVh0, 1);
...
for n = 1 : Nsv
  ...
  outlierProb(n) = largeshocksv.betadraw(alpha(n), beta(n), 1);
