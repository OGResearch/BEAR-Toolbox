    ...
    methods
        ...
        function initializeSampler(this, meta, longYXZ, dummiesYLX)
            ...
            function sample = sampler()
                ...
                [B, sigma, sample] = threshold_model.drawBSigma(sigma, threshold, ...
                    delay, thresholdvar, Y, LX, dummiesYLX); 

                threshold = threshold_model.drawThreshold(B, sigma, threshold, delay,...
                    thresholdvar, meanThreshold, opt.varThreshold, Y, LX,...
                    opt.thresholdPropStd); 

                delay = threshold_model.drawDelay(opt.maxDelay, B, sigma, threshold, thresholdvar,...
                    meanThreshold, opt.varThreshold, Y, LX);

                sample.beta = cell(estimLength, 1);
                sample.sigma_t = cell(estimLength, 1);
                for r = 1:2
                    regimeInd = threshold_model.getRegimeInd(threshold, delay, ... 
                        thresholdvar, r);    
