...
classdef Meta ...
    ...
    methods
        ...
        function update(this, options)
            ...
            %
            this.populateShockConcepts(options.shockNames);
        ...
        function populateShockConcepts(this, shockConcepts)
            if ~isempty(shockConcepts) && all(strlength(shockConcepts) > 0)
    ...
    methods
        ...
        function num = get.NumEndogenousNames(this)
            num = this.NumEndogenousConcepts;
        end%
